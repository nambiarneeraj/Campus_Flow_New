...
const upload_pic = async () => {
  ...
  formData.append('file', imageBlob, sessionStorage.getItem('admin_id') + ".png"); 
  formData.append('picname', sessionStorage.getItem('admin_id') + ".png");         
  formData.append('staffid', parseInt(sessionStorage.getItem('admin_id')));
  try {
