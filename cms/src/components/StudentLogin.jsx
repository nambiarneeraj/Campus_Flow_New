...
const upload_pic =  async () =>{
  ...
  formData.append('file', imageBlob, sessionStorage.getItem('student_id') + ".png"); 
  formData.append('picname', sessionStorage.getItem('student_id') + ".png");         
  formData.append('stdid', parseInt(sessionStorage.getItem('student_id')));
