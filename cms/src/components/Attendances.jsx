...
function Attendances() {
  ...
  const handleSearch = () => {
    if (selectedMonth && selectedSubject) {
      const month = selectedMonth.getMonth() + 1; // Numeric month
      const year = selectedMonth.getFullYear(); // Full year
      console.log("Searching for month:", month, "Year:", year, "Subject:", selectedSubject);
      // Call the API to fetch attendance data based on month, year, and subject
    } else {
